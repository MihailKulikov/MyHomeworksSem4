...
/// <summary>Represents the abstract syntax tree of an expression in a simple programming language that supports addition,
/// subtraction, multiplication and division of numbers and variables.</summary>
type Expression =
    | Number of int
